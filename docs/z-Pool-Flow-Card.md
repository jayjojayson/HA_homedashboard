...
config:
  ...
  image: /local/community/HA_homedashboard/pool-card/Pool-Flow-Card/pool-card.svg
  stylesheet: /local/community/HA_homedashboard/Pool-Flow-Card/pool-card/pool-card.css
  rules:
    - element: wasserlauf
